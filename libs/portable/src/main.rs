...
const APP_PREFIX: &str = "cevizdesk";
const APPNAME_RUNTIME_ENV_KEY: &str = "CEVIZDESK_APPNAME";
...
mod windows {
    ...
    pub const WIN_MAG_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_cevizdesk.exe";
    ...
    pub(super) fn copy_runtime_broker(dir: &PathBuf) {
        ...
        let _allow_err = Command::new("taskkill")
            .args(&["/F", "/IM", "RuntimeBroker_cevizdesk.exe"])
