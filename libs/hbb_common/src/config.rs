...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: Arc<RwLock<String>> = Arc::new(RwLock::new("Cevizdesk".to_owned()));
...
pub const LINK_DOCS_HOME: &str = "https://cevizdesk.com/docs/en/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://cevizdesk.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://github.com/cevizdesk/cevizdesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("cevizdesk docs home", LINK_DOCS_HOME),
        ("cevizdesk docs x11-required", LINK_DOCS_X11_REQUIRED),
        ("cevizdesk x11 headless", LINK_HEADLESS_LINUX_SUPPORT),
        ]);
}
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rs-ny.cevizdesk.com"];
