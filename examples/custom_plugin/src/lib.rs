use libcevizdesk::api::CevizdeskApiTable;
/// This file demonstrates how to write a custom plugin for Cevizdesk.
...
lazy_static::lazy_static! {
    ...
    // Do your own logic based on the API provided by Cevizdesk.
    pub static ref API: CevizdeskApiTable = CevizdeskApiTable::default();
}
