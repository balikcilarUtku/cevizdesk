...
mod windows {
    ...
    //  https://github.com/fufesou/CevizdeskIddDriver/blob/b370aad3f50028b039aad211df60c8051c4a64d6/CevizdeskIddDriver/CevizdeskIddDriver.inf#LL73C1-L73C40
    const IDD_DEVICE_STRING: &'static str = "CevizdeskIddDriver Device\0";
