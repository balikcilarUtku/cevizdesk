...
///
/// Note:
/// On linux, we use dbus to communicate multiple cevizdesk process.
...
const DBUS_NAME: &str = "org.cevizdesk.cevizdesk";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "Cevizdesk DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.cevizdesk.cevizdesk /dbus org.cevizdesk.cevizdesk.NewConnection string:'PEER_ID'`
