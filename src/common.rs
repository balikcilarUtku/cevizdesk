...
pub const PORTABLE_APPNAME_RUNTIME_ENV_KEY: &str = "CEVIZDESK_APPNAME";
...
async fn check_software_update_() -> hbb_common::ResultType<()> {
    let url = "https://github.com/cevizdesk/cevizdesk/releases/latest";
...
pub fn get_api_server(api: String, custom: String) -> String {
    ...
    "https://admin.cevizdesk.com".to_owned()
}

pub fn get_audit_server(api: String, custom: String, typ: String) -> String {
    let url = get_api_server(api, custom);
    if url.is_empty() || url.contains("cevizdesk.com") {
        return "".to_owned();
    }
