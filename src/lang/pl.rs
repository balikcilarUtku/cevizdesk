...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Cevizdesk może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować Cevizdesk w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić Cevizdesk przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić Cevizdesk na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [Cevizdesk Input]."),
        ...
        ("Language", "Język"),
        ("Keep Cevizdesk background service", "Zachowaj usługę Cevizdesk w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji Cevizdesk, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show Cevizdesk", "Pokaż Cevizdesk"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji Cevizdesk uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("install_cert_tip", "Instalacja certyfikatu Cevizdesk"),
        ("confirm_install_cert_tip", "To jest certyfikat testowy Cevizdesk, któremu można zaufać. Certyfikat jest używany do zaufania i instalowania sterowników Cevizdesk w razie potrzeby."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z Cevizdesk w Twojej sieci."),
        ...
        ("verify_cevizdesk_password_tip", "Weryfikuj hasło Cevizdesk"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu Cevizdesk i uruchomienia usługi - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_cevizdesk_server_pro_to_{}_tip", "Proszę zaktualizować Cevizdesk Server Pro do wersji {} lub nowszej!"),
