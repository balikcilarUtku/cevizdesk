...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na Cevizdesk mrežu..."),
        ...
        ("install_tip", "Zbog UAC Cevizdesk ne može raditi pravilno u nekim slučajevima. Da biste prevazišli UAC, kliknite taster ispod da instalirate Cevizdesk na sistem."),
        ...
        ("config_acc", "Da biste daljinski kontrolisali radnu površinu, Cevizdesk-u treba da dodelite \"Accessibility\" prava."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, Cevizdesk-u treba da dodelite \"Screen Recording\" prava."),
        ...
        ("android_input_permission_tip1", "Da bi daljinski uređaj kontrolisao vaš Android uređaj preko miša ili na dodir, treba da dozvolite Cevizdesk-u da koristi \"Accessibility\" servis."),
        ("android_input_permission_tip2", "Molimo pređite na sledeću stranicu sistemskih podešavanja, pronađite i unesite [Installed Services], uključite [Cevizdesk Input] servis."),
        ...
        ("Language", "Jezik"),
        ("Keep Cevizdesk background service", "Zadrži Cevizdesk kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite da onemogućite ovu funkciju, molimo idite na sledeću stranicu za podešavanje Cevizdesk aplikacije, pronađite i uđite u [Battery], isključite [Unrestricted]"),
        ("Start on Boot", ""),
        ...
        ("Show Cevizdesk", "Prikazi Cevizdesk"),
        ("This PC", "Ovaj PC"),
        ("or", "ili"),
