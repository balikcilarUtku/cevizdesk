...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Prêt"),
        ("Established", "Établi"),
        ("connecting_status", "Connexion au réseau Cevizdesk..."),
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à Cevizdesk."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à Cevizdesk l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser Cevizdesk à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [Cevizdesk Input]."),
        ...
        ("Language", "Langue"),
        ("Keep Cevizdesk background service", "Gardez le service Cevizdesk en arrière plan"),
        ...
        ("Show Cevizdesk", "Afficher Cevizdesk"),
        ("This PC", "Ce PC"),
        ("or", "ou"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à Cevizdesk l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à Cevizdesk les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de Cevizdesk en cours d'éxécution."),
        ...
        ("install_cert_tip", "Installer le certificat Cevizdesk"),
        ("confirm_install_cert_tip", "Il s'agit d'un certificat Cevizdesk, auquel on peut faire confiance. Le certificat sera utilisé pour approuver et installer les pilotes Cevizdesk si nécessaire."),
        ...
        ("verify_cevizdesk_password_tip", "Vérifier le mot de passe Cevizdesk"),
        ...
        ("scam_text1", "Si vous êtes au téléphone avec quelqu'un QUE VOUS NE CONNAISSEZ PAS et en qui VOUS N'AVEZ PAS CONFIANCE et qui vous a demandé d'utiliser Cevizdesk et de démarrer le service, ne le faites pas et raccrochez immédiatement."),
        ...
        ("upgrade_cevizdesk_server_pro_to_{}_tip", "Veuillez mettre à jour Cevizdesk Server Pro avec la version {} ou une version plus récente !"),
