...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Підключення до мережі Cevizdesk..."),
        ...
        ("install_tip", "Через UAC в деяких випадках Cevizdesk може працювати некоректно на віддаленому вузлі. Щоб уникнути UAC, натисніть кнопку нижче для встановлення Cevizdesk в системі"),
        ...
        ("config_acc", "Для віддаленого керування вашою стільницею, вам необхідно надати Cevizdesk дозволи \"Доступності\""),
        ("config_screen", "Для віддаленого доступу до вашої стільниці,вам необхідно надати Cevizdesk дозволи на \"Запис екрану\""),
        ...
        ("android_input_permission_tip1", "Для того, щоб віддалений пристрій міг керувати вашим Android-пристроєм за допомогою миші або торкання, вам необхідно дозволити Cevizdesk використовувати службу \"Спеціальні можливості\"."),
        ("android_input_permission_tip2", "Перейдіть на наступну сторінку системних налаштувань, знайдіть та увійдіть у [Встановлені служби], увімкніть службу [Cevizdesk Input]."),
        ...
        ("Language", "Мова"),
        ("Keep Cevizdesk background service", "Зберегти фонову службу Cevizdesk"),
        ...
        ("Show Cevizdesk", "Показати Cevizdesk"),
        ("This PC", "Цей ПК"),
        ("or", "чи"),
        ...
        ("config_microphone", "Для можливості віддаленої розмови, вам необхідно надати Cevizdesk дозвіл на \"Запис аудіо\""),
        ...
        ("verify_cevizdesk_password_tip", "Перевірте пароль Rustdesk"),
