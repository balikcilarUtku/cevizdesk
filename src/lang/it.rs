...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete Cevizdesk..."),
        ...
        ("install_tip", "A causa del controllo account uUtente (UAC), Cevizdesk potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare Cevizdesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a Cevizdesk il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a Cevizdesk il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a Cevizdesk di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [Cevizdesk Input]."),
        ...
        ("Language", "Lingua"),
        ("Keep Cevizdesk background service", "Mantieni il servizio di Cevizdesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione Cevizdesk, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show Cevizdesk", "Visualizza Cevizdesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a Cevizdesk 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a Cevizdesk."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di Cevizdesk."),
        ...
        ("install_cert_tip", "Installa certificato Cevizdesk"),
        ("confirm_install_cert_tip", "Questo è un certificato di test Cevizdesk, che può essere considerato attendibile.\nIl certificato verrà usato per certificarsi ed installare i driver Cevizdesk quando richiesto."),
        ...
        ("verify_cevizdesk_password_tip", "Conferma password Cevizdesk"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare Cevizdesk e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_cevizdesk_server_pro_to_{}_tip", "Aggiorna Cevizdesk Server Pro alla versione {} o successiva!"),
