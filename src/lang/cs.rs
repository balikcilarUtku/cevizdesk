...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Připojování k Cevizdesk síti..."),
        ...
        ("install_tip", "Kvůli řízení oprávnění v systému (UAC), Cevizdesk v některých případech na protistraně nefunguje správně. Abyste se UAC vyhnuli, klikněte na níže uvedené tlačítko a nainstalujte tak Cevizdesk do systému."),
        ("Click to upgrade", "Aktualizovat"),
        ("Click to download", "Stáhnout"),
        ("Click to update", "Aktualizovat"),
        ("Configure", "Nastavit"),
        ("config_acc", "Aby bylo možné na dálku ovládat vaši plochu, je třeba aplikaci Cevizdesk udělit oprávnění pro \"Zpřístupnění pro hendikepované\"."),
        ("config_screen", "Aby bylo možné přistupovat k vaší ploše na dálku, je třeba aplikaci Cevizdesk udělit oprávnění pro \"Nahrávání obsahu obrazovky\"."),
        ...
        ("android_input_permission_tip1", "Aby vzdálené zařízení mohlo ovládat vaše Android zařízení prostřednictví myši či dotyků, je třeba povolit, aby Cevizdesk mohlo používat službu „Zpřístupnění hendikepovaným“."),
        ("android_input_permission_tip2", "Přejděte na následující stránku nastavení systému, najděte a přejděte do [Nainstalované služby] a zapněte službu [Cevizdesk vstup]."),
        ...
        ("Language", "Jazyk"),
        ("Keep Cevizdesk background service", "Zachovat službu Cevizdesk na pozadí"),
        ("Ignore Battery Optimizations", "Ignorovat optimalizaci baterie"),
        ("android_open_battery_optimizations_tip", "Pokud chcete tuto funkci zakázat, přejděte na další stránku nastavení aplikace Cevizdesk, najděte a zadejte [Baterie], zrušte zaškrtnutí [Neomezeno]."),
        ...
        ("Show Cevizdesk", "Zobrazit Cevizdesk"),
        ...
        ("config_input", "Chcete-li ovládat vzdálenou plochu pomocí klávesnice, musíte udělit oprávnění Cevizdesk \"Sledování vstupu\"."),
        ("config_microphone", "Abyste mohli mluvit na dálku, musíte udělit oprávnění Cevizdesk \"Nahrávat zvuk\"."),
        ...
        ("still_click_uac_tip", "Stále vyžaduje, aby vzdálený uživatel kliknul na OK v okně UAC spuštěného Cevizdesku."),
        ...
        ("install_cert_tip", "Instalace certifikátu Cevizdesk"),
        ("confirm_install_cert_tip", "Jedná se o testovací certifikát Cevizdesk, kterému lze důvěřovat. Certifikát bude v případě potřeby použit k důvěryhodnosti a instalaci ovladačů Cevizdesk."),
        ...
        ("verify_cevizdesk_password_tip", "Ověření hesla Cevizdesk"),
        ...
        ("scam_text1", "Pokud telefonujete s někým, koho NEZNÁTE a komu NEDŮVĚŘUJETE a kdo vás požádal o použití služby Cevizdesk a její spuštění, nepokračujte v hovoru a okamžitě zavěste."),
        ...
        ("upgrade_cevizdesk_server_pro_to_{}_tip", "Aktualizujte prosím Cevizdesk Server Pro na verzi {} nebo novější!"),
