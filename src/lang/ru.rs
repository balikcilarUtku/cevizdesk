...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Подключение к сети Cevizdesk..."),
        ...
        ("install_tip", "В некоторых случаях из-за UAC Cevizdesk может работать неправильно на удалённом узле. Чтобы избежать UAC, нажмите кнопку ниже для установки Cevizdesk в системе."),
        ...
        ("Configure", "Настроить"),
        ("config_acc", "Чтобы удалённо управлять своим рабочим столом, вы должны предоставить Cevizdesk права \"доступа\""),
        ("config_screen", "Для удалённого доступа к рабочему столу вы должны предоставить Cevizdesk права \"снимок экрана\""),
        ...
        ("android_input_permission_tip1", "Чтобы удалённое устройство могло управлять вашим Android-устройством с помощью мыши или нажатий, необходимо разрешить Cevizdesk использовать службу \"Специальные возможности\"."),
        ("android_input_permission_tip2", "Перейдите на соответствующую страницу системных настроек, найдите и войдите в \"Установленные службы\", включите службу \"Cevizdesk Input\"."),
        ...
        ("Language", "Язык"),
        ("Keep Cevizdesk background service", "Держать в фоне службу Cevizdesk"),
        ...
        ("Show Cevizdesk", "Показать Cevizdesk"),
        ...
        ("config_input", "Чтобы управлять удалённым рабочим столом с помощью клавиатуры, необходимо предоставить Cevizdesk разрешения \"Мониторинг ввода\"."),
        ("config_microphone", "Чтобы разговаривать с удалённой стороной, необходимо предоставить Cevizdesk разрешение \"Запись аудио\"."),
        ...
        ("still_click_uac_tip", "По-прежнему требуется, чтобы удалённый пользователь нажал \"OK\" в окне UAC при запуске Cevizdesk."),
        ...
        ("install_cert_tip", "Установить сертификат Cevizdesk"),
        ("confirm_install_cert_tip", "Это тестовый сертификат Cevizdesk, которому можно доверять. Он будет использоваться только по необходимости для установки драйверов Cevizdesk."),
        ...
        ("verify_cevizdesk_password_tip", "Подтвердить пароль Cevizdesk"),
        ...
        ("scam_text1", "Если вы разговариваете по телефону с кем-то, кого вы НЕ ЗНАЕТЕ и НЕ ДОВЕРЯЕТЕ, и он просит вас использовать Cevizdesk и запустить его службу, не продолжайте и немедленно прервите разговор."),
        ...
        ("upgrade_cevizdesk_server_pro_to_{}_tip", "Обновите Cevizdesk Server Pro до версии {} или новее!"),
