...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem Cevizdesk-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann Cevizdesk in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren Cevizdesk auf dem System."),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie Cevizdesk Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie Cevizdesk die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie Cevizdesk erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"Cevizdesk Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep Cevizdesk background service", "Cevizdesk im Hintergrund ausführen"),
        ...
        ("Show Cevizdesk", "Cevizdesk anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie Cevizdesk die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie Cevizdesk die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von Cevizdesk auf \"Ja\" klicken."),
        ...
        ("install_cert_tip", "Cevizdesk-Zertifikat installieren"),
        ("confirm_install_cert_tip", "Dies ist ein Cevizdesk-Testzertifikat, dem vertraut werden kann. Das Zertifikat wird verwendet, um Cevizdesk-Treibern bei Bedarf zu vertrauen und diese zu installieren."),
        ...
        ("verify_cevizdesk_password_tip", "Cevizdesk-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, Cevizdesk zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_cevizdesk_server_pro_to_{}_tip", "Bitte aktualisieren Sie Cevizdesk Server Pro auf die Version {} oder neuer!"),
