...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til Cevizdesk-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan Cevizdesk ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere Cevizdesk på systemet"),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give Cevizdesk mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [Cevizdesk Input] tjenesten."),
        ...
        ("Language", "Sprog"),
        ("Keep Cevizdesk background service", "Behold Cevizdesk baggrundstjeneste"),
