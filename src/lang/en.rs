...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the Cevizdesk network..."),
        ...
        ("install_tip", "Due to UAC, Cevizdesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install Cevizdesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant Cevizdesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant Cevizdesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow Cevizdesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [Cevizdesk Input] service."),
        ...
        ("doc_mac_permission", "https://cevizdesk.com/docs/en/manual/mac/#enable-permissions"),
        ("Ignore Battery Optimizations", "Ignore battery optimizations"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next Cevizdesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant Cevizdesk \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant Cevizdesk \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running Cevizdesk."),
        ...
        ("install_cert_tip", "Install Cevizdesk certificate"),
        ("confirm_install_cert_tip", "This is a Cevizdesk testing certificate, which can be trusted. The certificate will be used to trust and install Cevizdesk drivers when required."),
        ...
        ("verify_cevizdesk_password_tip", "Verify Cevizdesk password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use Cevizdesk and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_cevizdesk_server_pro_to_{}_tip", "Please upgrade Cevizdesk Server Pro to version {} or newer!"),
        ("pull_group_failed_tip", "Failed to refresh group"),
        ("doc_fix_wayland", "https://cevizdesk.com/docs/en/manual/linux/#x11-required"),
    ].iter().cloned().collect();
}
