...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Menghubungkan ke jaringan Cevizdesk..."),
        ...
        ("install_tip", "Karena UAC, Cevizdesk tidak dapat bekerja dengan baik sebagai sisi remote dalam beberapa kasus. Untuk menghindari UAC, silakan klik tombol di bawah ini untuk menginstal Cevizdesk ke sistem."),
        ("Click to upgrade", "Klik untuk upgrade"),
        ("Click to download", "Klik untuk unduh"),
        ("Click to update", "Klik untuk memperbarui"),
        ("Configure", "Konfigurasi"),
        ("config_acc", "Untuk mengontrol Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Aksesibilitas\" Cevizdesk."),
        ("config_screen", "Untuk mengakses Desktop Anda dari jarak jauh, Anda perlu memberikan izin \"Perekaman Layar\" Cevizdesk."),
        ...
        ("android_input_permission_tip1", "Agar perangkat jarak jauh dapat mengontrol perangkat Android Anda melalui mouse atau sentuhan, Anda harus mengizinkan Cevizdesk untuk menggunakan layanan \"Aksesibilitas\"."),
        ("android_input_permission_tip2", "Silakan buka halaman pengaturan sistem berikutnya, temukan dan masuk ke [Layanan Terinstal], aktifkan layanan [Input Cevizdesk]."),
        ...
        ("Language", "Bahasa"),
        ("Keep Cevizdesk background service", "Pertahankan Cevizdesk berjalan pada service background"),
        ...
        ("Show Cevizdesk", "Tampilkan Cevizdesk"),
        ("This PC", "PC ini"),
        ("or", "atau"),
        ...
        ("config_input", "Untuk menggunakan input keyboard remote, anda perlu memberikan izin \"Pemantauan Input\" pada Cevizdesk"),
        ("config_microphone", "Untuk berbicara secara remote, anda perlu memberikan izin \"Rekam Audio\" pada Cevizdesk"),
        ...
        ("still_click_uac_tip", "Masih memerlukan persetujuan pihak pengguna remote untuk mengklik OK pada jendela UAC Cevizdesk yang sedang berjalan"),
        ...
        ("install_cert_tip", "Install sertifikat Cevizdesk"),
        ("confirm_install_cert_tip", "Ini adalah sertifikat pengujian Cevizdesk, yang dapat dipercaya. Sertifikat ini akan digunakan untuk menginstal driver Cevizdesk saat diperlukan"),
        ...
        ("verify_cevizdesk_password_tip", "Verifikasi Kata Sandi Cevizdesk"),
        ...
        ("scam_text1", "Jika Anda sedang berbicara di telepon dengan seseorang yang TIDAK dikenal dan mereka meminta anda untuk menggunakan Cevizdesk, jangan lanjutkan dan segera tutup panggilan."),
        ...
        ("upgrade_cevizdesk_server_pro_to_{}_tip", "Silahkan perbarui Cevizdesk Server Pro ke versi {} atau yang lebih baru!"),
